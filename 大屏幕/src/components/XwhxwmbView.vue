    ...
    <dv-full-screen-container class="container">
      ...
      <div class="contentView">
        ...
        <div class="centerView">
          ...
          <div class="mapView">
            <dv-border-box-7>
              <div class="iframeView">
                <iframe src="http://smart-ideas.com.cn/mapView/xwhmap.html?scenicId=43a3c0756f854990ad7fd13f597cda3c" frameborder="0" width="680px" height="750px"></iframe>
              </div>
            </dv-border-box-7>
          </div>
          ...
          <!-- 温馨提示 -->
          <div class="wxts">
            <dv-border-box-10>温馨提示：欢迎乘坐玄武湖游船</dv-border-box-10>
          </div>
        </div>
...
export default {
  ...
  methods: {
    createCode(scenicId){
      let qrcode = new QRCode('qrcode', {
        width: 150,  // 二维码宽度
        height: 150, // 二维码高度
        text: 'http://hd.smart-ideas.com.cn/xwhWeb/xwhRefund/?scenicId=' + scenicId + '&date=' + new Date().getTime()
      })
    },
    clearCode () {
  ...
  mounted: function(){
    let scenicId = '43a3c0756f854990ad7fd13f597cda3c';
    let that = this;
    // 初始化时间
    ...
    setInterval(function(){
      ...
      if(seconds == 1 || seconds % 20 == 0){
        // 获取租赁详情
        axios.get('http://hd.smart-ideas.com.cn/xwhpark/deviceDataView/getDeviceShipLeaseInfo?scenicId=' + scenicId)
          .then(function(res){
        ...
        // 获取退款详情
        axios.get('http://hd.smart-ideas.com.cn/xwhpark/deviceDataView/getDeviceShipRefundInfo?scenicId=' + scenicId)
          .then(function(res){
        ...
        // 获取在租人数
        axios.get('http://hd.smart-ideas.com.cn/xwhpark/deviceDataView/getDeviceShipLeaseQuantity?scenicId=' + scenicId)
          .then(function(res){
            console.log(res);
            that.config1 = {
