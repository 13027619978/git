          ...
          <div class="mapView">
            <dv-border-box-7>
              <div class="iframeView">
                <iframe src="http://smart-ideas.com.cn/mapView/xwhmap.html?scenicId=f57419d544e741838fb789056f63ee80" frameborder="0" width="680px" height="750px"></iframe>
              </div>
            </dv-border-box-7>
          </div>
...
export default {
  ...
  mounted: function(){
    let scenicId = 'f57419d544e741838fb789056f63ee80';
    let that = this;
    // 初始化时间
