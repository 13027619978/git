          ...
          <div class="mapView">
            <dv-border-box-7>
              <div class="iframeView">
                <iframe src="http://smart-ideas.com.cn/mapView/xwhmap.html?scenicId=696dc31a1125458fa5ba1696f6e445c7" frameborder="0" width="680px" height="750px"></iframe>
              </div>
            </dv-border-box-7>
          </div>
...
export default {
  ...
  mounted: function(){
    let scenicId = '696dc31a1125458fa5ba1696f6e445c7';
    let that = this;
    // 初始化时间
