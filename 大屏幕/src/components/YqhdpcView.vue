      ...
      <div class="contentView">
        ...
        <div class="rightView">
          ...
          <div class="rightNotice">
            ...
            <dv-scroll-board :config="refundConfig" style="width:480px;height:280px" />
          </div>
        ...
        <div class="centerView">
          ...
          <div class="videoView">
            <dv-border-box-7>
              <div class="rideNotice">
                <iframe style="width: 100%;height: 600px;" src="http://smart-ideas.com.cn/mapView/yqhzjcmap.html" frameborder="0"></iframe>
              </div>
            </dv-border-box-7>
          </div>
          ...
          <div class="progressView">
            ...
            <div class="progressList">
              ...
              <dv-border-box-8 :reverse="true">3.上船游玩</dv-border-box-8>
          ...
          <!-- 购票流程 -->
          <div class="progressView">
            <p class="progressTitle">小丑鱼船租赁流程</p>
            <div class="progressList">
              <dv-border-box-8 :reverse="true">1.穿好救生衣</dv-border-box-8>
              <dv-border-box-8 :reverse="true">2.排队等待</dv-border-box-8>
              <dv-border-box-8 :reverse="true">3.扫描付款并出示</dv-border-box-8>
              <dv-border-box-8 :reverse="true">4.上船游玩</dv-border-box-8>
              <dv-border-box-8 :reverse="true">5.扫码退押金</dv-border-box-8>
            </div>
          </div>

          <!-- 温馨提示 -->
          <div class="wxts">
            <dv-border-box-10>温馨提示：欢迎乘坐雁栖湖自驾船</dv-border-box-10>
          </div>
        </div>
        ...
        <div class="leftView">
          <div class="leftContent">
            ...
            <!-- 租赁情况 -->
            <div class="leaseView" style="padding: 0 20px;">
              <p class="noticeTitle" style="padding: 0;">租赁情况</p>
            </div>
          </div>
        </div>
  ...
  mounted: function(){
    ...
    setInterval(function(){
      ...
      if(seconds == 1 || seconds % 20 == 0){
        // 获取租赁详情
        axios.get('http://api.smart-ideas.com.cn/yqhpark/deviceDataView/getDeviceShipLeaseInfo')
          .then(function(res){
        ...
        // 获取退款详情
        axios.get('http://api.smart-ideas.com.cn/yqhpark/deviceDataView/getDeviceShipRefundInfo')
          .then(function(res){
        ...
        // 获取租赁情况
        axios.get('http://api.smart-ideas.com.cn/yqhpark/deviceDataView/getDeviceShipLeasePercent?type=6')
          .then(function(res){
            that.option1 = {
              radius: '70%',
              activeRadius: '80%',
