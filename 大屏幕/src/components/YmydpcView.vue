      ...
      <div class="contentView">
        ...
        <div class="leftView">
          <div class="leftContent">
            ...
            <div class="leaseDetailView">
              <p class="noticeTitle" style="padding: 0;">租赁详情</p>
              <dv-scroll-board :config="leaseConfig" style="width:100%;height:215px" />
            </div>
            ...
            <div class="leaseView">
              <div class="leaseList">
                <div class="leaseItem">
                  <p>四人电瓶船</p>
                  <dv-active-ring-chart :config="option1" style="width:130px;height:130px" />
                </div>
                <div class="leaseItem">
                  <p>六人电瓶船</p>
                  <dv-active-ring-chart :config="option2" style="width:130px;height:130px" />
                </div>
                <div class="leaseItem">
                  <p>四人脚踏船</p>
                  <dv-active-ring-chart :config="option3" style="width:130px;height:130px" />
                </div>
                <div class="leaseItem">
                  <p>六人脚踏船</p>
                  <dv-active-ring-chart :config="option4" style="width:130px;height:130px" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="centerView">
          ...
          <div class="videoView">
            <dv-border-box-7>
              <div class="rideNotice">
                <iframe style="width: 100%;height: 490px;" src="http://smart-ideas.com.cn/mapView/ymymap.html" frameborder="0"></iframe>
              </div>
            </dv-border-box-7>
          </div>
          ...
          <div class="progressView">
            <p class="progressTitle">电瓶船租赁流程</p>
          ...
          <!-- 购票流程 -->
          <div class="progressView">
            <p class="progressTitle">脚踏船租赁流程</p>
            <div class="progressList">
              <dv-border-box-8 :reverse="true">1.联系管理员</dv-border-box-8>
              <dv-border-box-8 :reverse="true">2.付款码付押金</dv-border-box-8>
              <dv-border-box-8 :reverse="true">3.打印订单上船</dv-border-box-8>
              <dv-border-box-8 :reverse="true">4.上岸扫码退押金</dv-border-box-8>
            </div>
          </div>
          ...
          <!-- 温馨提示 -->
          <div class="wxts">
            <dv-border-box-10>温馨提示：欢迎乘坐圆明园自驾船</dv-border-box-10>
          </div>
        </div>
        ...
        <div class="rightView">
          ...
          <div class="rightNotice">
            ...
            <dv-scroll-board :config="refundConfig" style="width:500px;height:280px" />
          </div>
  ...
  methods: {
    createCode(){
      let qrcode = new QRCode('qrcode', {
        width: 250,  // 二维码宽度
        height: 250, // 二维码高度
        text: 'http://api.smart-ideas.com.cn/ymyPosRefund/?date=' + new Date().getTime()
      })
    },
    clearCode () {
  ...
  mounted: function(){
    ...
    setInterval(function(){
      ...
      if(seconds == 1 || seconds % 20 == 0){
        ...
        that.createCode();
        // 获取租赁详情
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceShipLeaseInfo')
          .then(function(res){
            ...
            let lastLength = 4 - dataList.length;
            if(lastLength > 0){
        ...
        // 获取退款详情
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceShipRefundInfo')
          .then(function(res){
            ...
            let lastLength = 5 - dataList.length;
            if(lastLength > 0){
              for(var i = 0; i < lastLength; i++){
                dataList.push(['-', '-', '-']);
              }
        ...
        // 获取在入园人数
        axios.get('http://node.smart-ideas.com.cn:3001/datav/ymy/getPeopleInfo')
          .then(function(res){
            console.log(res);
            // 总入园人数
        ...
        // 获取租赁情况
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceShipLeasePercent?type=6')
          .then(function(res){
            that.option1 = {
              radius: '70%',
              activeRadius: '80%',
        ...
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceShipLeasePercent?type=7')
          .then(function(res){
            that.option2 = {
              radius: '70%',
              activeRadius: '80%',
        ...
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceShipLeasePercent?type=8')
          .then(function(res){
            that.option3 = {
              radius: '70%',
              activeRadius: '80%',
        ...
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceShipLeasePercent?type=9')
          .then(function(res){
            that.option4 = {
              radius: '70%',
              activeRadius: '80%',
