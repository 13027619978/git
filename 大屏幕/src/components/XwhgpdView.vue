          ...
          <div class="mapView">
            <dv-border-box-7>
              <div class="iframeView">
                <iframe src="http://smart-ideas.com.cn/mapView/xwhmap.html?scenicId=9030c8e60fa34f37b674a30f3c890143" frameborder="0" width="680px" height="750px"></iframe>
              </div>
            </dv-border-box-7>
          </div>
...
export default {
  ...
  mounted: function(){
    let scenicId = '9030c8e60fa34f37b674a30f3c890143';
    let that = this;
    // 初始化时间
