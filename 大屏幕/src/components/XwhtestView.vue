          ...
          <div class="mapView">
            <dv-border-box-7>
              <div class="iframeView">
                <!-- <iframe src="http://smart-ideas.com.cn/mapView/xwhmap.html?scenicId=41ab29656e5b405a9c94871488050ec3" frameborder="0" width="680px" height="750px"></iframe> -->
...
export default {
  ...
  mounted: function(){
    let scenicId = '41ab29656e5b405a9c94871488050ec3';
    let that = this;
    // 初始化时间
