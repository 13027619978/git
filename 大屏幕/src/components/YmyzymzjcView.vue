    ...
    <dv-full-screen-container class="container">
      ...
      <div class="contentView">
        ...
        <div class="leftView">
          <div class="leftContent">
            ...
            <div class="leaseDetailView">
              ...
              <dv-scroll-board :config="leaseConfig" style="width:420px;height:285px" />
            </div>
        ...
        <div class="centerView">
          ...
          <div class="videoView">
            <dv-border-box-7>
              <img class="mapImg" src="../assets/ymyZjcLx.png">
          ...
          <!-- 温馨提示 -->
          <div class="wxts">
            <dv-border-box-10>温馨提示：欢迎乘坐圆明园自驾车</dv-border-box-10>
          </div>
        </div>
        ...
        <div class="rightView">
          ...
          <div class="rightNotice">
            ...
            <dv-scroll-board :config="refundConfig" style="width:500px;height:360px" />
          </div>
          ...
          <div class="qrcodeView">
            ...
            <div class="qrcodeImgView">
              <img class="qrcodeImg" src="../assets/ymyRefund.png">
            </div>
  ...
  mounted: function(){
    ...
    setInterval(function(){
      ...
      if(seconds == 1 || seconds % 20 == 0){
        // 获取租赁详情
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceBikeRefundInfo')
          .then(function(res){
        ...
        // 获取租赁情况
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceBikeLeasePercent?type=0')
          .then(function(res){
            that.option1 = {
              title: {
                text: '双人自行车',
              ...
              series: [
                {
                  type: 'pie',
                  data: [
                    { name: '已租', value: parseInt(res.data[0].y)?parseInt(res.data[0].y):0 },
                    { name: '未租', value: parseInt(res.data[1].y)?parseInt(res.data[1].y):0 }
                  ],
                  radius: ['40%', '50%'],
                  insideLabel: {
                    show: true
        ...
        axios.get('http://api.smart-ideas.com.cn/ymypark/deviceDataView/getDeviceBikeLeasePercent?type=1')
         .then(function(res){
           that.option2 = {
             title: {
               text: '四人自行车',
