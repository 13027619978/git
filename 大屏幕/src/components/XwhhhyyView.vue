          ...
          <div class="mapView">
            <dv-border-box-7>
              <div class="iframeView">
                <iframe src="http://smart-ideas.com.cn/mapView/xwhmap.html?scenicId=a9f74e0b584945bea69985cd17f66a9d" frameborder="0" width="680px" height="750px"></iframe>
              </div>
            </dv-border-box-7>
          </div>
...
export default {
  ...
  mounted: function(){
    let scenicId = 'a9f74e0b584945bea69985cd17f66a9d';
    let that = this;
    // 初始化时间
