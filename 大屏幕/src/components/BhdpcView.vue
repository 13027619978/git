    ...
    <dv-full-screen-container class="container">
      ...
      <div class="contentView">
        ...
        <div class="centerView">
          ...
          <div class="videoView">
            <dv-border-box-7>
              <div class="rideNotice">
                <iframe style="width: 100%;height: 710px;" src="http://smart-ideas.com.cn/mapView/bhzjcmap.html" frameborder="0"></iframe>
              </div>
            </dv-border-box-7>
          </div>
          ...
          <!-- 温馨提示 -->
          <div class="wxts">
            <dv-border-box-10>温馨提示：欢迎乘坐北海公园游船</dv-border-box-10>
          </div>
        </div>
        ...
        <div class="leftView">
          <div class="leftContent">
            ...
            <div class="leaseView" style="padding: 0 20px;">
              ...
              <dv-active-ring-chart :config="option1" style="width:250px;height:250px;margin: 0 auto;" />
            </div>
          </div>
        </div>
  ...
  mounted: function(){
    ...
    setInterval(function(){
      ...
      if(seconds == 1 || seconds % 20 == 0){
        // 获取租赁详情
        axios.get('http://api.smart-ideas.com.cn/bhpark/deviceDataView/getDeviceShipLeaseInfo')
          .then(function(res){
        ...
        // 获取退款详情
        axios.get('http://api.smart-ideas.com.cn/bhpark/deviceDataView/getDeviceShipRefundInfo')
          .then(function(res){
        ...
        // 获取租赁情况
        axios.get('http://api.smart-ideas.com.cn/bhpark/deviceDataView/getDeviceShipLeasePercent')
          .then(function(res){
            that.option1 = {
              radius: '70%',
              activeRadius: '80%',
