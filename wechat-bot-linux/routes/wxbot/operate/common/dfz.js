...
function getCheckTicketInfo(enterpriseCode, ticketGroupNum, room, ticketSalesChannelsNum){
	var parkName;
	if(enterpriseCode == 'TgsEpcHty' && ticketGroupNum == 'TGN20221219133840067'){
		parkName = '胡同游什刹海';
	}else if(enterpriseCode == 'TgsEpcHty' && ticketGroupNum == 'TGN20211223142858166'){
		parkName = '胡同游温榆河';
	}else if(enterpriseCode == 'TgsEpcHty' && ticketGroupNum == 'TGN20221219114138804'){
		parkName = '胡同游南海子';
	}else if(enterpriseCode == 'TgsEpcSy' && ticketGroupNum == 'TGN20221219120936423'){
		parkName = '盛亚南海子';
	}
