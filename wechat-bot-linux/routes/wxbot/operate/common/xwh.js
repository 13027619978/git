	...
	const req = http.request(options, (res) => {
	  res.on('data', (d) => {
	    ...
	    if(res.code == "SUCCESS"){
			...
			// 一卡通
			// var jfmCardShipIncome = res.data.jfmCardShipIncome;
			// jfmCardShipIncome = jfmCardShipIncome?parseInt(jfmCardShipIncome):0;
			// var tltCardShipIncome = res.data.tltCardShipIncome;
			// tltCardShipIncome = tltCardShipIncome?parseInt(tltCardShipIncome):0;
			// var xwmCardShipIncome = res.data.xwmCardShipIncome;
			// xwmCardShipIncome = xwmCardShipIncome?parseInt(xwmCardShipIncome):0;
			// var lzCardShipIncome = res.data.lzCardShipIncome;
			// lzCardShipIncome = lzCardShipIncome?parseInt(lzCardShipIncome):0;
			// var xwmbCardShipIncome = res.data.xwmbCardShipIncome;
			// xwmbCardShipIncome = xwmbCardShipIncome?parseInt(xwmbCardShipIncome):0;
			// var hhyCardShipIncome = res.data.hhyCardShipIncome;
			// hhyCardShipIncome = hhyCardShipIncome?parseInt(hhyCardShipIncome):0;
			// var hpmCardShipIncome = res.data.hpmCardShipIncome;
			// hpmCardShipIncome = hpmCardShipIncome?parseInt(hpmCardShipIncome):0;
			// var czmCardShipIncome = res.data.czmCardShipIncome;
			// czmCardShipIncome = czmCardShipIncome?parseInt(czmCardShipIncome):0;
			// var ygCardShipIncome = res.data.ygCardShipIncome;
			// ygCardShipIncome = ygCardShipIncome?parseInt(ygCardShipIncome):0;
			// var fqCardShipIncome = res.data.fqCardShipIncome;
			// fqCardShipIncome = fqCardShipIncome?parseInt(fqCardShipIncome):0;
			// var gpdCardShipIncome = res.data.gpdCardShipIncome;
			// gpdCardShipIncome = gpdCardShipIncome?parseInt(gpdCardShipIncome):0;
			// var hzCardShipIncome = res.data.hzCardShipIncome;
			// hzCardShipIncome = hzCardShipIncome?parseInt(hzCardShipIncome):0;
			// var tltxCardShipIncome = res.data.tltxCardShipIncome;
			// tltxCardShipIncome = tltxCardShipIncome?parseInt(tltxCardShipIncome):0;
			// var jfmIncome = parseInt(jfmShipIncome + jfmCardShipIncome);
			// var tltIncome = parseInt(tltShipIncome + tltCardShipIncome);
			// var xwmIncome = parseInt(xwmShipIncome + xwmCardShipIncome);
			// var lzIncome = parseInt(lzShipIncome + lzCardShipIncome);
			// var xwmbIncome = parseInt(xwmbShipIncome + xwmbCardShipIncome);
			// var hhyIncome = parseInt(hhyShipIncome + hhyCardShipIncome);
			// var hpmIncome = parseInt(hpmShipIncome + hpmCardShipIncome);
			// var czmIncome = parseInt(czmShipIncome + czmCardShipIncome);
			// var ygIncome = parseInt(ygShipIncome + ygCardShipIncome);
			// var fqIncome = parseInt(fqShipIncome + fqCardShipIncome);
			// var gpdIncome = parseInt(gpdShipIncome + gpdCardShipIncome);
			// var hzIncome = parseInt(hzShipIncome + hzCardShipIncome);
			// var tltxIncome = parseInt(tltxShipIncome + tltxCardShipIncome);
