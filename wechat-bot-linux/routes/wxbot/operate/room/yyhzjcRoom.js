...
/***** 野鸭湖自驾船 *******/
/********************/
async function yyhzjcRoomDeal(msg){
...
function completeRescue(host, room, code, contact){
	const options = {
		hostname: host,
		path: '/yyhpark/deviceRobot/removeRescue?deviceSn='+ code,
		method: 'GET'
	};
...
function sendCommand(type, host, room, code, contact){
	const options = {
		hostname: host,
		path: '/yyhpark/deviceRobot/sendCommand?deviceSn='+ code +'&type=' + type,
		method: 'GET'
	};
...
function updateStatus(status, host, room, code, contact){
	const options = {
		hostname: host,
		path: '/yyhpark/deviceRobot/updateStatus?deviceSn='+ code +'&status=' + status,
		method: 'GET'
	};
...
function getLastedPhone(host, room, code, contact){
	const options = {
		hostname: host,
		path: '/yyhpark/deviceRefundRobot/getLastedPhone?deviceSn='+ code,
		method: 'GET'
	};
...
function refund(host, room, refundType, refundValue, refundWall, refundMoney, contact){
	...
	const options = {
		hostname: host,
		path: '/yyhpark/deviceRefundRobot/refund',
		method: 'POST',
		headers: {
