...
/***** 园博园群代码 *******/
/********************/
async function yqhzjcRoomDeal(msg){
...
function completeRescue(host, room, code, contact){
	const options = {
		hostname: host,
		path: '/yqhpark/deviceRobot/removeRescue?deviceSn='+ code,
		method: 'GET'
	};
...
function sendCommand(type, host, room, code, contact){
	const options = {
		hostname: host,
		path: '/yqhpark/deviceRobot/sendCommand?deviceSn='+ code +'&type=' + type,
		method: 'GET'
	};
...
function updateStatus(status, host, room, code, contact){
	const options = {
		hostname: host,
		path: '/yqhpark/deviceRobot/updateStatus?deviceSn='+ code +'&status=' + status,
		method: 'GET'
	};
...
function getLastedPhone(host, room, code, contact){
	const options = {
		hostname: host,
		path: '/yqhpark/deviceRefundRobot/getLastedPhone?deviceSn='+ code,
		method: 'GET'
	};
...
function refund(host, room, refundType, refundValue, refundWall, refundMoney, contact){
	...
	const options = {
		hostname: host,
		path: '/yqhpark/deviceRefundRobot/refund',
		method: 'POST',
		headers: {
