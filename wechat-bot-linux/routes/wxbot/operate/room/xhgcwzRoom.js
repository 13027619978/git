...
async function xhgcwzRoomDeal(msg){
	...
	if(msg.type() == wechat.bot.Message.Type.Text){
		...
		if(content.indexOf('鲜花港微信上账统计') != -1 && content.indexOf('-') != -1){
			var dateString = content.split('鲜花港微信上账统计')[0];
			...
			getWxInfoByDate(dateString,'iotsmart', host, room);
		}
	}
}
