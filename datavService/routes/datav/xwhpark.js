...
router.get('/GetParkingFlowReport', async function(req1, res1) {
	...
	let params = {
		...
		"ts": tsString,
		"reqId": tsString,
		"startTime": nowYear + '-' + nowMonth + '-' + nowDay + " 00:00:00",
		"endTime":  nowYear + '-' + nowMonth + '-' + nowDay + " 23:59:59"
	}
	...
	let requertParams = {
		...
		"startTime": nowYear + '-' + nowMonth + '-' + nowDay + " 00:00:00",
		"endTime":  nowYear + '-' + nowMonth + '-' + nowDay + " 23:59:59",
		"key": md5(sort_ascii(params)).toUpperCase()
	}
	
	axios({
			url: 'http://kp-open.keytop.cn/unite-api/api/wec/GetParkingFlowReport',
			method: 'post',
			data: requertParams,
			headers: {
...
router.get('/GetFreeSpaceNum', async function(req1, res1) {
	...
	axios({
			url: 'http://kp-open.keytop.cn/unite-api/api/wec/GetFreeSpaceNum',
			method: 'post',
			data: requertParams,
			headers: {
				'content-type': 'application/json',
