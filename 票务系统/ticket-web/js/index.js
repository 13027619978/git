$(function(){
	...
	app.wxUserInfo(function(){
		...
		}else if(app.getCookie('ybyNp120') == '1'){
			window.location.href = 'ticket.html?ticketInfoId=/2c9141f47d377f26017d50e432814c39/';
		}else{
	...
	app.encryptGetAjax('ticketInfo/encrypt/getSalesList', {
		...
		if(res.code == '10000'){
			...
			if(enterpriseCode == 'TgsEpcSlfz'){
				...
				noticeString += '<font style="color:red;font-weight:bold;">入园须持48小时核酸阴性证明。</font><br>';
				noticeString += '我承诺：<br>';
			...
			if(enterpriseCode == 'TgsEpcYby'){
				...
				layer.open({
					...
					btn1: function(){
						if($('.isAgree').prop("checked")){
							layer.closeAll();
							if(ticketGroupNum != 'TGN20220831183429283'){
