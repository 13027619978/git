app = {
	...
	wxUserInfo:function(success){
		...
		var ticketId = '2c9141f47f9ac6d1017f9ad8ef460126';
		var promotionnumber = app.getQueryString('promotionnumber');
					...
					$.ajax({
						...
						success: function(res){
							if(res.code == 'success'){
								...
								// 判断帐密有效性
								app.postAjax('renbao/query', {
									promotionnumber: promotionnumber
								}, function(res){
									app.setCookie('promotionnumber', promotionnumber);
